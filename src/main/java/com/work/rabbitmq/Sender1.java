...
public class Sender1 {
	...
	/**
	 * 发送给默认的exchange amqp框架在启动的时候 默认创建了8个exchange DirectExchanage 只有一个队列会接收
	 */
	public void sendDirectExchanage() {
		...
		this.rabbitTemplate.setConfirmCallback(new ConfirmCallback() {
			...
			public void confirm(CorrelationData arg0, boolean arg1, String arg2) {
				if (arg1) {
					System.out.println("发送成功，收到ack");
				}else{
					System.out.println("发送失败，收到ack");
				}
			}
